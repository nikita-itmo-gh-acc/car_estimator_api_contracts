...
const (
	PredictionService_Predict_FullMethodName   = "/car_estimator.predict.PredictionService/Predict"
	PredictionService_GetImages_FullMethodName = "/car_estimator.predict.PredictionService/GetImages"
)
...
type PredictionServiceClient interface {
	...
	GetImages(ctx context.Context, in *ImagesRequest, opts ...grpc.CallOption) (*ImagesResponse, error)
}
...
func (c *predictionServiceClient) GetImages(ctx context.Context, in *ImagesRequest, opts ...grpc.CallOption) (*ImagesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ImagesResponse)
	err := c.cc.Invoke(ctx, PredictionService_GetImages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PredictionServiceServer interface {
	...
	GetImages(context.Context, *ImagesRequest) (*ImagesResponse, error)
...
func (UnimplementedPredictionServiceServer) GetImages(context.Context, *ImagesRequest) (*ImagesResponse, error) {
...
func _PredictionService_GetImages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ImagesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PredictionServiceServer).GetImages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PredictionService_GetImages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PredictionServiceServer).GetImages(ctx, req.(*ImagesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PredictionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "car_estimator.predict.PredictionService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PredictionService_GetImages_Handler,
		},
	},
